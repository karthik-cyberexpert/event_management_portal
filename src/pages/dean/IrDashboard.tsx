...
const IrDashboard = () => {
  ...
  return (
    <div className="space-y-8 max-w-full overflow-hidden animate-in fade-in duration-700">
      <div>
        <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight">Dean IR Dashboard</h2>
        <p className="text-slate-500 font-medium mt-1">Review and manage international and research event requests.</p>
      </div>
