...
CREATE TABLE `event_reports` (
  ...
  `final_report_remarks` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `student_participants` int DEFAULT '0',
  `faculty_participants` int DEFAULT '0',
  `external_participants` int DEFAULT '0',
  `activity_lead_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-03-14 13:58:51
