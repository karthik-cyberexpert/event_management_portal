...
CREATE TABLE `profiles` (
  ...
  `role` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'coordinator, hod, dean, principal, admin, etc.',
  `department` text COLLATE utf8mb4_unicode_ci,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `club` text COLLATE utf8mb4_unicode_ci,
  `professional_society` text COLLATE utf8mb4_unicode_ci,
